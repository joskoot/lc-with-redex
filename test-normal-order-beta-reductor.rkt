#lang racket ; File test-normal-order-β-reductor.rkt"
(require (only-in "curried-lc-grammar.rkt" curried-lc-grammar))
(require "normal-order-beta-reductor.rkt")
...
(normal-order-test curried-lc-grammar normal-order-β-reductor βNf?)
